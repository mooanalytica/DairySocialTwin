...
def _disable_user_site_packages() -> None:
    """Keep user-site packages from shadowing the active Python environment."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--input-root", default=str(DEFAULT_INPUT_ROOT), help="Root containing Stage 1 tracking and keypoint CSV folders.")
